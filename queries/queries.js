...
const updateSkaterStatusQuery = async (id,estado) => {
  const consulta = {
...
export {addSkaterQuery, getSkatersQuery, getSkaterQuery, deleteSkaterQuery, editSkaterQuery, updateSkaterStatusQuery}